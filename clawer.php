...
//mysqli_query($link, "insert into adsapi.ios_app_category(ios_app_category_id, parent_id, ios_app_category_name, locale_names) values('1111','1212','name','{}')");
$CAT=null;
...
foreach($CAT as $country => $countryInfo) {
    ...
    foreach($countryInfo as $catId=> $info) {
        ...
        mysqli_query($link, "insert into adsapi.ios_app_category(ios_app_category_id, parent_id, ios_app_category_name, locale_names) values('{$catId}','".$info['parent_id']."','".$info['name']."','{}')");
    }
}
mysqli_close($link);
